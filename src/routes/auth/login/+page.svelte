...
<div class="flex min-h-screen items-center justify-center bg-background">
	<div class="w-full max-w-sm space-y-8 rounded-lg border p-8 shadow-sm">
		...
		<div class="space-y-3">
			<Button href="/auth/login/github" variant="outline" class="w-full justify-center gap-3">
			...
			<Button href="/auth/login/google" variant="outline" class="w-full justify-center gap-3">
