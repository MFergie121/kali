	...
	<nav class="border-muted bg-muted/30 rounded-lg border p-6">
		...
		<div class="grid gap-x-8 gap-y-1 sm:grid-cols-2">
			...
			<div class="space-y-1">
				...
				<a href="#tips" class="text-primary block text-sm hover:underline">Tips</a>
...
GET /head-to-head?team_a=sydney-swans&team_b=collingwood&venue=SCG</pre>
  ...
  "meta": { "year": 2024, "count": 18 }
		...
		<!-- ── TIPS ──────────────────────────────────────────────────────── -->
		<section id="tips" class="scroll-mt-20 space-y-4 border-t pt-12">
			...
			<div class="space-y-1">
				...
				<table class="w-full text-sm">
					<thead><tr class="border-b text-left"><th class="text-muted-foreground pb-2 font-medium">Name</th><th class="text-muted-foreground pb-2 font-medium">Type</th><th class="text-muted-foreground pb-2 font-medium">Required</th><th class="text-muted-foreground pb-2 font-medium">Description</th></tr></thead>
					<tbody>
						<tr class="border-b"><td class="py-2 font-mono text-xs">year</td><td class="py-2 font-mono text-xs">integer</td><td class="py-2 font-semibold">Yes</td><td class="text-muted-foreground py-2">Season year</td></tr>
						<tr><td class="py-2 font-mono text-xs">round</td><td class="py-2 font-mono text-xs">integer</td><td class="py-2 font-semibold">Yes</td><td class="text-muted-foreground py-2">Round number</td></tr>
					</tbody>
				</table>
			</div>
			<div class="space-y-1">
				<p class="text-muted-foreground text-xs font-medium uppercase tracking-wide">Example</p>
				<pre class="bg-muted overflow-x-auto rounded-md p-4 font-mono text-sm">curl "/api/afl/v1/tips?year=2026&round=4" -H "Authorization: Bearer YOUR_KEY"</pre>
			</div>
			<div class="space-y-1">
				<p class="text-muted-foreground text-xs font-medium uppercase tracking-wide">Response</p>
				<pre class="bg-muted overflow-x-auto rounded-md p-4 font-mono text-sm">{`{
...
curl /api/afl/v1/fixture?year=2026</pre>
			</div>
			<div class="space-y-1">
				<p class="text-muted-foreground text-xs font-medium uppercase tracking-wide">Response</p>
				<pre class="bg-muted overflow-x-auto rounded-md p-4 font-mono text-sm">{`{
...
GET /predictions?team_id=sydney&settled=true</pre>
  ...
  "meta": { "limit": 50, "offset": 0, "count": 9, "total": 9 }
	...
	<!-- ── Get started CTA ── -->
	<section class="border-t pt-12 text-center">
		<p class="text-muted-foreground mb-4 text-sm">Ready to start building?</p>
		<a href="/auth/login" class="doc-cta-btn">get a free api key →</a>
	</section>
