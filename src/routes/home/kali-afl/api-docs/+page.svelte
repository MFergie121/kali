...
curl /api/afl/v1/fixture?year=2024</pre>
  ...
  "games": [ ... ]  // Squiggle fixture data
		...
		<!-- ── PREDICTIONS ──────────────────────────────────────────────── -->
		<section id="predictions" class="scroll-mt-20 space-y-10 border-t pt-12">
...
# All settled predictions (outcome known) for a team
  ...
  "data": [
    {
      ...
      "year": 2026,
      "round": 9,
      "homeTeamId": "fremantle",
      "homeTeam": "Fremantle",
      "homeShortName": "Fremantle",
      "awayTeamId": "hawthorn",
      "awayTeam": "Hawthorn",
      "awayShortName": "Hawthorn",
      "venue": "Optus Stadium",
      "date": "2026-05-09 19:40:00",
      "homeProbability": 58.3,
      "awayProbability": 41.7,
      "squiggleConsensus": 61,
      "factors": [
        { "label": "Form", "homeScore": 0.72, "awayScore": 0.41, "weight": 0.2 },
        { "label": "Scoring Power", "homeScore": 0.65, "awayScore": 0.50, "weight": 0.2 }
      ],
      "homeBreakdown": {
        "form": 0.72, "scoring": 0.65, "stats": 0.58,
        "venue": 0.70, "h2h": 0.55, "squiggle": 0.61
      },
      "awayBreakdown": {
        "form": 0.41, "scoring": 0.50, "stats": 0.44,
        "venue": 0.30, "h2h": 0.45, "squiggle": 0.39
      },
      "modelVersion": "v1",
      "actualWinner": null,
      "computedAt": "2026-05-06T08:00:00.000Z",
      "settledAt": null
    }
  ],
  "meta": { "limit": 50, "offset": 0, "count": 9, "total": 9 }
			...
			<div class="space-y-4 border-t pt-8">
				...
				<p class="text-muted-foreground text-sm">Returns a single prediction by numeric ID.</p>
				<div class="space-y-1">
					<p class="text-muted-foreground text-xs font-medium uppercase tracking-wide">Example</p>
					<pre class="bg-muted overflow-x-auto rounded-md p-4 font-mono text-sm">curl /api/afl/v1/predictions/1 -H "Authorization: Bearer YOUR_KEY"</pre>
				</div>
				<p class="text-muted-foreground text-sm">Response shape is the same as a single item from <code class="bg-muted rounded px-1 font-mono text-xs">GET /predictions</code>, wrapped in <code class="bg-muted rounded px-1 font-mono text-xs">{`{ "data": { ... } }`}</code>.</p>
				<div class="space-y-1">
					<p class="text-muted-foreground text-xs font-medium uppercase tracking-wide">actualWinner values</p>
					<table class="w-full text-sm">
						<thead><tr class="border-b text-left"><th class="text-muted-foreground pb-2 font-medium">Value</th><th class="text-muted-foreground pb-2 font-medium">Meaning</th></tr></thead>
						<tbody>
							<tr class="border-b"><td class="py-2 font-mono text-xs">null</td><td class="text-muted-foreground py-2">Match not yet played</td></tr>
							<tr class="border-b"><td class="py-2 font-mono text-xs">"home"</td><td class="text-muted-foreground py-2">Home team won</td></tr>
							<tr class="border-b"><td class="py-2 font-mono text-xs">"away"</td><td class="text-muted-foreground py-2">Away team won</td></tr>
							<tr><td class="py-2 font-mono text-xs">"draw"</td><td class="text-muted-foreground py-2">Match drawn</td></tr>
						</tbody>
					</table>
				</div>
			</div>
